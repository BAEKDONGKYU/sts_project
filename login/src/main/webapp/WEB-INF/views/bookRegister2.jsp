...
<body>
	<div class="out">
		...
		<div class="clear_both"><h1>本の登録</h1></div>
		<div id="contentDiv">
			<div style="margin-top: 30px;"></div>
			<form action="/bookInfoCheck" method="post" id="bookInfo">
				<table>
					<tr>
